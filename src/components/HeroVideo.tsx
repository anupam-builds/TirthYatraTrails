  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        {/* Full-bleed HTML5 Video targeting /videos/lanterns.mp4 */}
        {!hasError && (
          <video
            ref={videoRef}
            autoPlay
          ...
          >
            <source src={videoUrl || DEFAULT_VIDEO} type="video/mp4" />
          </video>
        )}
      </div>

      {/* LAYER z-10: Deep Dark Gradient Vignette Scrims for Perfect Text Legibility */}
      ...
      {/* LAYER z-20: Clean Left-Aligned Content Container */}
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl space-y-4 sm:space-y-5">
          
          {/* Eyebrow Pill + Brand Seal */}
          <div className="flex items-center gap-3.5 flex-wrap">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white shadow-2xl border-2 border-white/60 p-1 flex items-center justify-center shrink-0 transition-transform hover:scale-105">
              <img
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-full text-[11px] sm:text-xs font-bold tracking-wider bg-white/10 backdrop-blur-md border border-white/20 text-orange-300 uppercase shadow-lg">
